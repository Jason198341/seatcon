...
const translations = {
    ...
    en: {
        ...
        // 전시물 및 발표자 정보
        'exhibitionButton': 'Exhibition Items',
        'speakersButton': 'Speakers',
        'exhibitionModalTitle': 'Exhibition Items',
        'speakersModalTitle': 'Conference Speakers',
        'exhibitionSearchPlaceholder': 'Search exhibitions...',
        'speakersSearchPlaceholder': 'Search speakers...',
        'exhibitionResultCount': '{count} items found',
        'speakersResultCount': '{count} presentations found',
        'currentFilter': 'Filtered by: {filter}',
        'clearFilter': 'Clear filter',
        'exhibitionNumber': 'No.',
        'exhibitionName': 'Name',
        'exhibitionCompany': 'Company',
        'exhibitionContact': 'Contact',
        'exhibitionPhone': 'Phone',
        'exhibitionEmail': 'Email',
        'speakersNumber': 'No.',
        'speakersTopic': 'Topic',
        'speakersGroup': 'Group',
        'speakersDepartment': 'Department',
    ...
    ko: {
        ...
        // 전시물 및 발표자 정보
        'exhibitionButton': '전시물 목록',
        'speakersButton': '발표자 정보',
        'exhibitionModalTitle': '전시물 목록',
        'speakersModalTitle': '컨퍼런스 발표자',
        'exhibitionSearchPlaceholder': '전시물 검색...',
        'speakersSearchPlaceholder': '발표자 검색...',
        'exhibitionResultCount': '{count}개 항목 발견',
        'speakersResultCount': '{count}개 발표 항목 발견',
        'currentFilter': '필터링: {filter}',
        'clearFilter': '필터 지우기',
        'exhibitionNumber': '번호',
        'exhibitionName': '전시명',
        'exhibitionCompany': '회사명',
        'exhibitionContact': '담당자',
        'exhibitionPhone': '연락처',
        'exhibitionEmail': '이메일',
        'speakersNumber': '번호',
        'speakersTopic': '발표주제',
        'speakersGroup': '그룹',
        'speakersDepartment': '부서',
        'speakersPresenter': '발표자',
    ...
    hi: {
        ...
        // 전시물 및 발표자 정보
        'exhibitionButton': 'प्रदर्शनी आइटम',
        'speakersButton': 'वक्ता',
        'exhibitionModalTitle': 'प्रदर्शनी आइटम',
        'speakersModalTitle': 'सम्मेलन वक्ता',
        'exhibitionSearchPlaceholder': 'प्रदर्शनी खोजें...',
        'speakersSearchPlaceholder': 'वक्ता खोजें...',
        'exhibitionResultCount': '{count} आइटम मिले',
        'speakersResultCount': '{count} प्रस्तुतियां मिलीं',
        'currentFilter': 'फ़िल्टर: {filter}',
        'clearFilter': 'फ़िल्टर हटाएं',
        'exhibitionNumber': 'क्र.',
        'exhibitionName': 'नाम',
        'exhibitionCompany': 'कंपनी',
        'exhibitionContact': 'संपर्क',
        'exhibitionPhone': 'फोन',
        'exhibitionEmail': 'ईमेल',
        'speakersNumber': 'क्र.',
        'speakersTopic': 'विषय',
        'speakersGroup': 'समूह',
        'speakersDepartment': 'विभाग',
        'speakersPresenter': 'प्रस्तुतकर्ता',
    ...
    zh: {
        ...
        // 전시물 및 발표자 정보
        'exhibitionButton': '展览项目',
        'speakersButton': '演讲者',
        'exhibitionModalTitle': '展览项目',
        'speakersModalTitle': '会议演讲者',
        'exhibitionSearchPlaceholder': '搜索展览...',
        'speakersSearchPlaceholder': '搜索演讲者...',
        'exhibitionResultCount': '找到 {count} 个项目',
        'speakersResultCount': '找到 {count} 个演讲',
        'currentFilter': '已筛选: {filter}',
        'clearFilter': '清除筛选',
        'exhibitionNumber': '编号',
        'exhibitionName': '名称',
        'exhibitionCompany': '公司',
        'exhibitionContact': '联系人',
        'exhibitionPhone': '电话',
        'exhibitionEmail': '电子邮件',
        'speakersNumber': '编号',
        'speakersTopic': '主题',
        'speakersGroup': '分组',
        'speakersDepartment': '部门',
        'speakersPresenter': '演讲者',
